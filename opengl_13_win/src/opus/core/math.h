...
internal Vec2 heading_vec2_scaled(float32 angle, float32 scale);
internal Vec2 heading_inverse_vec2_scaled(float32 angle, float32 scale);
...
internal Vec2 inverse_scaled_heading_to_vec2(Vec2 start, Vec2 end, float32 scale);
