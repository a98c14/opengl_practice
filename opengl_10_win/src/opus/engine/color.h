...
global const Color ColorAmber100A = { .r= 0xff, .g = 0xe5, .b=0x7f, .a = 0xff };
global const Color ColorAmber200A = { .r= 0xff, .g = 0xd7, .b=0x40, .a = 0xff };
global const Color ColorAmber400A = { .r= 0xff, .g = 0xc4, .b=0x00, .a = 0xff };
global const Color ColorAmber700A = { .r= 0xff, .g = 0xab, .b=0x00, .a = 0xff };
